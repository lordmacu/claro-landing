                    ...
                    <div className="col-lg-5 text-left">
                            <div className="row">
                                    <div className="col-lg-3">
                                            <img href=" # " src="./imagen/Sim-Only-1-m.png"/>
                                    </div>
                                            ...
                                            <div className="btn-group mar-y-1">
                                                    ...
                                                    (1 Día)    </button>
                                                            ...
                                                            <ul className="dropdown-menu">
                                                                    <li href=" # " className="itemColor"><a  data-price-type-action="prepaid" data-value="hide" data-line="">Ocultar todas las opciones de prepago</a></li>
                                                                    <li href=" # " className="itemColor"><a className="itemColor" data-price-type-action="prepaid" data-value="show" data-line="">Mostrar todas las opciones de prepago</a></li>
