...
class SectionList extends React.Component{
    ...
    constructor(props) {
       ...
       this.state={
        ...
        stepsMensajesValue:["Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado","Ilimitado"],
                                    ...
                                    />
                                        ...
                                        <div className="col-lg-12">
                                            ...
                                            <ReactSlider
                                                      ...
                                                      trackClassName="example-track"
                                                      onChange={(value)=>{
                                                        this.filterPlanByKey("Mensajes",this.state.stepsMensajesValue[value])
