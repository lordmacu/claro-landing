                        ...
                        <div className="col-sm-12">
                            <div className="row">
                                ...
                                <div className="col-12 text-center">
                                    <p><img src="../imagen/arrow-mobile.png"/></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-12 ml-3">
                            <div className="row">
                                <div className="col-4 col-4 pl-0 pr-0">
                                    <p className="mb-0 p-font"> <i className="fa fa-check mr-1"></i>Whatsapp<span> Ilimitados</span> </p>
                                    <p className="mb-0 p-font"><i className="fa fa-check mr-1"></i>Llamadas Claro<span> Ilimitados</span> </p>
                                </div>
                                <div className="col-4 col-4 pl-0 pr-0">
                                    <p className="mb-0 p-font"><i className="fa fa-check mr-1"></i>SMS SMS  <span>(50 grátis)</span></p>
                                    <p className="mb-0 p-font"><i className="fa fa-check mr-1"></i><span>$50</span> Saldo de regalo</p>
                                </div>
                                <div className="col-4 col-4 pl-0 pr-0">
                                    <p className="mb-0 p-font"><i className="fa fa-check mr-1"></i>SMS SMS  <span>(50 grátis)</span></p>
                                    <p className="mb-0 p-font"><i className="fa fa-check mr-1"></i><span>$50</span> Saldo de regalo</p>
