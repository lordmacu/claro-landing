                                ...
                                <div className="row border-panel-nav">
                                    ...
                                    <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"  onClick={(e) => this.filterPlanByKey("messages", 1, e)} href="#">Prepago (68)  $0/recarga</a>
                                                <a class="dropdown-item"  onClick={(e) => this.getAllResults("minutos", 1, e)} href="#">SinContrato (4) $349/recarga</a>
                                                <a class="dropdown-item"  onClick={(e) => this.filterPlanByKey("internet", 2, e)} href="#">Contrato (28) $200/recarga</a>
