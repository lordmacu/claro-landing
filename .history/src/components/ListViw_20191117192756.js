                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-ms-12 pl-5">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12  pr-0">
                                                    <div class="btn-group"><button class="btn btn-sm dropdown-toggle prepagoDrop" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="positionDrop"><strong><i class="fa fa-info-circle mr-1"></i>Prepago</strong><span class="p-font">(1 Día)</span></span></button><div class="dropdown-menu"><a class="dropdown-item" href="#">Ocultar todas las opciones de prepago</a><a class="dropdown-item" href="#">Mostrar todas las opciones de prepago</a><a class="dropdown-item" href="#">Otros Filtros</a></div></div>
                                                <div class="dropdown">
                                                    <a ref={this.compañiaRef} class="btn  dropdown-toggle inputColor " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    COMPAÑIAS
                                                    </a>
