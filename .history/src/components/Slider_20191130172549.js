                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12">
                                                                <p className="mb-0 p-font">
                                                                    REGION:
                                                                    <button type="button" class="btn font-Titillium-Web btn-contrat pl-0 pr-3 pt-2" data-toggle="dropdown" aria-expanded="false "><p class="text-white">CON CONTRATO</p></button>
                                                                </p>
                                                                <p className="mb-0 p-font">
                                                                    CONTRATO:
                                                                    <span>
