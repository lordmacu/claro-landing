                                                                                    ...
                                                                                    <div className="col-6 pl-0">
                                                                                        <div className="btn-group">
                                                                                            ...
                                                                                            <div className="dropdown-menu">
                                                                                                ...
                                                                                                <a className="dropdown-item" onClick={(e) => this.clearAllResults(e)} href="#">Prepago (28) $200/recarga</a>
                                                                            ...
                                                                            <div className="col-3">
                                                                                <div className="row">
                                                                                    <div className="col-5 ml-2">
                                                                                        <buttom type="buttom" className="btn btn-circle-nav">
                                                                                            <img id=" " src="../imagen/arrow-up-down.png"/>
                                                                                        </buttom>
                                                                                    </div>
                                                                                    <div className="col-5">
                                                                                    <buttom type="buttom" className="btn btn-circle-nav">
