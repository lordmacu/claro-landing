                                ...
                                <div className="col-lg-4">
                                    <form className="form-inline ">
                                        <div className="dropdown ">
                                            <button
                                                className="btn  dropdown-toggle drow-list"
                                                type="button"
                                ...
                                <div className="row">
                                    <div className="col-lg-12 pt-lg-3 pl-lg-1">
                                        <ul className="nav-list pl-lg-3">
                                            ...
                                            <li className="pl-2" href="/home">
                                                <a href="/home">Planes de Celular</a>
                                            </li>
                                        </ul>
                                ...
                                <div className="col-lg-4">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 section-phone-position">
                                            ...
                                            <div class="btn-group "
                                                 ref={this.typeRef}
                                                 className="btn-section-phone "
                                            >
                                                    <button class="btn btn-sm dropdown-toggle prepagoDropChange" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span className="positionDropChange ">
                                                                <strong>Cambiar</strong>
                                                            </span>
                                                    </button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">Agregar Smartphone</a>
                                                        <a class="dropdown-item" href="#">Planes Smartphone</a>
                                                        <a class="dropdown-item" href="#">Disponible con cada plan</a>
                                                    </div>
                                                 </div>
                                   </div>
                                    </div>
                                                ...
                                                <li className="nav-item">
                                                    <div className="section-btn-item-list">
                                                        <button
                                                            type="button"
                                                            className="btn btn-list-plan-item "
                                                            onClick={(e) => this.getAllResults("messages", "minutos", 10, e)}>
                                                            <div className="row">
                                                                <div className="col-lg-12">
                                                ...
                                                <li className="nav-item">
                                                    <div className="section-btn-item-list">
                                                        <button
                                                            type="button"
                                                            className="btn btn-list-plan-item "
                                                            onClick={(e) => this.filterPlanByKey("internet", 40, e)}>
                                                            <div className="row">
                                                                <div className="col-lg-12">
