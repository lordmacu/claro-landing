                    ...
                    <div className="row">
                        <div className="col-lg-5 text-center mt-3">
                            ...
                            <div className="img-logo">
                                <img alt=" " className="imga-mobile" src={this.state.item.image}/>
                            </div>
                        ...
                        <div className="col-lg-7 mt-2 pl-0">
                            <div className="row">
                                <div className="col-lg-12">
                                    <p className="p-phone-selector">{this.state.item.name}
                                    </p>
                                </div>
                ...
                <div className="col-lg-4 text-center">
                    <div className="row">
                        <div className="col-lg-3 donut-left">
                            <div className="row">
                                <div className="col-lg-12">
                                    <Donut data={this.state.item.messages} maxvalue={2000}/>
                                </div>
                                <div className="col-lg-12 sutitles-donut ml-lg-3">
                                    <span className="font-weight">{this.state.item.messages}</span>
                        ...
                        <div className="col-lg-4 donut-right">
                            <div className="row">
                                <div className="col-lg-12">
                                    <Donut data={this.state.item.internet} maxvalue={15360}/>
                                </div>
                                <div className="col-lg-12 sutitles-donut">

                                    <span className="font-weight">{this.calculateInternetValue(15360, this.state.item.internet)}</span>
