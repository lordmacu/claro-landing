...
class SectionNavbar extends React.Component {
    render() {
        return (
           ...
           <a className="navbar-brand display-on-in-desktop nav-title" href="#">COMPARADOR DE PLANES</a>
           <a className="navbar-brand display-on-in-mobile" href="#">CP</a>
                ...
                <div className="collapse navbar-collapse display-on-in-decktop button" id="navbarTogglerDemo03">
                ...
                <div className="collapse navbar-collapse collapse-mobile display-on-in-mobile" id="navbarTogglerDemo03">
                        <ul className="icons-rigth  ml-md-auto d-md-flex display-on-in-desktop" id="menu">
                      <li><img src="./imagen/twtt.png"/></li> 
                      <li><img src="./imagen/intsa.png"/></li>
                      <li><img src="./imagen/link.png"/></li>
