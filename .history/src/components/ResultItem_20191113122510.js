                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12 ">
                                    <p className="mb-0 p-font">
                                        <strong><i class="fa fa-check"></i>Red: AT&T</strong>
                                    </p>
                                    <p className="mb-0 p-font">
                                    <i class="fa fa-check"></i>Minutos
                                        <span>Ilimitados</span>
                                    </p>
                                    <p className="mb-0 p-font"><i class="fa fa-check"></i>SMS<span>00</span>
                                    </p>
                                    <p className="mb-0 p-font"><i class="fa fa-check"></i>Datos Ilimitados<span>00</span>
                                    </p>
                                </div>
                            </div>
                        </div>
