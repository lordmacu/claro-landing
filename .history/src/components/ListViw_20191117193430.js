                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-ms-12 pl-5">
                                            <div className="row">
                                                ...
                                                <div class="dropdown">
                                                    <a ref={this.compañiaRef} class="btn-light dropdown-toggle inputColor " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    COMPAÑIAS
                                                    </a>
