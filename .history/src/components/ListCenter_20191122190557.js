            ...
            <div className="container ">
                ...
                <div className="col-12 display-on-in-mobile">
                                                                        <div className="row">
                                                                            <div className="col-8">
                                                                                <div className="row">
                                                                                    <div className="col-4 pt-2 pb-2 mr-3 font-Titillium-Web">
                                                                                        <p>RESULTADO:</p>
                                                                                    </div>
                                                                                    <div className="col-6 pl-0">
                                                                                        <div class="btn-group">
                                                                                            <button
                                                                                                type="button"
                                                                                                class="btn font-Titillium-Web btn-contrat pl-0 pr-0"
                                                                                    ...
                                                                                    <div className="col-12">
                                                                                        <p class="plan-font">PLANES MÁS ECONÓMICOS</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div className="col-3">
                                                                                <div className="row">
                                                                                    <div className="col-5 ml-2">
                                                                                        <div className="row btn-circle-nav">
                                                                                            <div className="col-6">
                                                                                            <i class="fa fa-arrow-up"><i class="fa fa-arrow-down"></i></i>
                                                                                            </div>
                                                                                            <div className="col-6">
                                                                    ...
                                                                    <div className="row ">
                                                                        <div className="col-lg-1">
                                                                            <div className="circle-filter-arrow">
                                                                                <img className="up-arrow" src="../imagen/up-arrow.png"/>
                                                                            </div>
                                                                        </div>
