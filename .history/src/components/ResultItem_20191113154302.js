                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="btn-group">
                                        <button
                                            className="btn btn-sm dropdown-toggle prepagoDrop"
                                            type="button"
                                            ...
                                            <span className="positionDrop">
                                                <strong>
                                                    <i className="fa fa-info-circle"></i>Prepago</strong>
                                                <span className="p-font">(1 Día)</span>
                                            </span>
                                        </button>
                                        <div className="dropdown-menu">
                                            <a className="dropdown-item" href="#">Ocultar todas las opciones de prepago</a>
                                            <a className="dropdown-item" href="#">Mostrar todas las opciones de prepago</a>
                                            <a className="dropdown-item" href="#">Otros Filtros</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12 ">
                ...
                <div className="col-lg-2">
                    ...
                    <div className="btn-group">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li className="itemColor">
                                <a href=" # " className="itemColor" data-show-filter-modal="1" data-line="1">Ocultar resultados de Movistar</a>
                            </li>
                            <li className="itemColor">
