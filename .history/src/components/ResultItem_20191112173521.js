        ...
        return (
            <div className="row">
                        ...
                        <div className="row">
                                <div className="col-lg-6 donut-left">
                                    <div className="row">
                                            ...
                                            <p>Minutos</p> 
                                            <small className="text-muted-dounut">{this.calculateMensagesValue(2000,this.props.item.messages)} Mensajes</small> 
                                            </div>
                                    </div>
                            </div>
                    ...
                    <div className="col-lg-2 border-btn">
                        <buttom type="submit" className="btn btn-primary-donut ">Ver Detalle</buttom>
                    </div>
        </div>
        );
    }
