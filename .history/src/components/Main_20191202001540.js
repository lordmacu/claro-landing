                        ...
                        <div className="row">
                            ...
                            <div className="container pl-0 pr-0">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="card btn btn-link collapsed"
                                            type="button"
                                            data-toggle="collapse"
                                            ...
                                            class="collapse" >
                                                ...
                                                <div className="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <i class="fa fa-check"></i><p>1 GB de internet + WhatsApp gratis.</p>
                                                        <i class="fa fa-check"></i><p>Llamadas ilimitadas a todo Claro</p>
                                                        <i class="fa fa-check"></i><p>50 minutos a las compañias </p>
                                                        <i class="fa fa-check"></i><p>50 SMS incluidos a todo destino</p>
                                                        <i class="fa fa-check"></i><p>Claro video incluido</p>
                                                           <i class="fa fa-check"></i><p>Saldo incliodo: $50</p>
                                                        </div>
                                                        <div className="col-lg-16">
