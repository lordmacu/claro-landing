                                    ...
                                    <div className="col-lg-7">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <p>Unefon Ilimitado 10 {this.props.item.internet}</p>
                                            </div>
                                            <div className="col-lg-12">
                        ...
                        <div className="row">
                                <div className="col-lg-6 donut-left">
                                    <div className="row">
                                            ...
                                            <span className="font-weight">50</span> 
                                            <p>Minutos</p> 
                                            <small className="text-muted-dounut">+ 50 Mensajes</small> 
                                            </div>
                                    </div>
                            </div>
                            ...
                            <div className="row">
                                            ...
                                            <div className="col-lg-12 sutitles-donut">
                                            <span className="font-weight">100MB</span> 
                                            <p>Datos</p> 
