                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="item-filter-list">
                                                            <div className="content-filter">
                                                                <p className="mb-0 ml-1 container-item-filter-list ">Filtrar</p>
                                                                <button type="submit" className="btn-fliter btn-primary-donut:hover container-item-filter-list">
                                                                    <i className="fa fa-sliders"></i>
                                                                </button>
                                                            </div>  
                                                        </div>
                                                        <div className="item-filter-list">
                                                            ...
                                                            <div className="btn-group btn-ordenar container-item-filter-list order-by-button">
                                                                                <button
                                                                                    type="button"
                                                                                    className="btn font-Titillium-Web"
                                                                                    aria-expanded="false"
