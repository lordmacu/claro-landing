                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="row">
                            ...
                            <div class="dropdown">
                                <div class="dropdown-toggle curso-pointer "  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="pr-1">OPCIONES SIN EQUIPO </span>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <p className="subtitle mt-0">Datos
                                    ...
                                    <div className="col-lg-12  pr-0">
                                        ...
                                        <p className="font-bold">Compañia actual</p>
                                        <select
