    ...
    getFilters(){
        ...
        const res = fetch('http://comparador.tiendaclaro.uy/getFilters', {
            ...
            .then((responseJson) => {
                ...
                var stapsArray=[];
                var filtersSelection=responseJson.filtersSelection;

                console.log("aqui mano ",filtersSelection);
                for(var i =0; i <filtersSelection.length;i++){
                    stapsArray[filtersSelection[i].id]=filtersSelection[i].filters;
                }
