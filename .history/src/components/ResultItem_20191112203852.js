                                ...
                                <div className="col-lg-12">
                                    <div className="btn-group mar-y-1">
                                        <button
                                            ...
                                            data-title=""
                                            data-original-title=""
                                            data-content="Este paquete vence cada día "
                                            data-placement="top"
                                            data-toggle="popover"
                                            data-container="body"
                                            type="button"
                                            className="btn btn-info btn-xs text-break font-2"
                                            data-stop-propagation="">
                                            <span className="fa fa-info-circle align-text-top mr-1"></span>
                                            <strong>Prepago</strong>
                                            (1 Día)
                                        </button>
                                        <button
                                            type="button"
                                            className="btn btn-info btn-xs dropdown-toggle font-2"
                                            data-toggle="dropdown"
                                            aria-haspopup="true"
                                            aria-expanded="false"
                                            data-enable-when-ready="">
