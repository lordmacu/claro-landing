          ...
          <div className="col-lg-12 main"> 
               <div className="row">
                 ...
                 <div className="col-lg-12 nav-planes-list ">
                  ...
                  <ul className="nav item-list">
                    ...
                    <div className="col-lg-1">
                      <ul className="item-list nav-btn-End">
                        ...
                        <button type="button" className="btn dropdawn-end dropdawn-rigth dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Filtrar por
                          </button>
                  ...
                  <div className="col-lg-12 shadow-result" key={item.id}>
