                                                ...
                                                <div className="row">
                                                    <div className="col-lg-5 text-center mt-3">
                                                        ...
                                                        <div className="img-logo">
                                                            <img alt=" " className="imga-mobile" src={this.props.state.item.image}/>
                                                        </div>
                                                    ...
                                                    <div className="col-lg-7 mt-2 pl-0">
                                                        <div className="row">
                                                            <div className="col-lg-12">
                                                                <p className="p-phone-selector">{this.props.state.item.name}
                                                                </p>
                                                            </div>

                                                            <div className="col-lg-12">
                                                                <p className="mb-0 p-font">
                                                                    <i className="fa fa-check mr-2"></i>Whatsapp<span>
                                                                        Ilimitados</span>
                                                                </p>
                                                                <p className="mb-0 p-font">
                                                                    <i className="fa fa-check mr-2"></i>Llamadas Claro<span>
                                                                        Ilimitados</span>
                                                                </p>
                                                                <p className="mb-0 p-font">
                                                                    <i className="fa fa-check mr-2"></i>SMS SMS
                                                                    <span>(50 grátis)</span>
                                                                </p>
                                                                <p className="mb-0 p-font">
                                                    ...
                                                    <div className="col-lg-3 donut-left">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12 sutitles-donut ml-lg-3">
                                                                <span className="font-weight">messages</span>
