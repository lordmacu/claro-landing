                                        ...
                                        <div className="row">
                                            <div className="col-lg-5 col-sm-12">
                                                <form className="filter-list" onSubmit={this.filterPhone}>
                                                    <div className="row">
                                                        <div className="col-lg-12 container-slide">
                                                            <div className="row">
                                                                <div className="col-lg-12">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-12">
                                                                    <p className="subtitle">MINUTOS:
                                                                        <b className="rest-font value-filter">{this.calculateMinutos()}</b>
                                                                    </p>
                                                                    <div className="whith-silider">
                                                                        <ReactSlider
                                                                            className="horizontal-slider"
                                                        ...
                                                        <div className="col-lg-12 container-slide">
                                                            <p className="subtitle">SMS:
                                                                <b className="rest-font value-filter">{this.claculaSms()}</b>
                                                            </p>
                                                            <div className="row">
                                                                <div className="col-lg-12">
                                                                    <div className="whith-silider" ref={this.smsRef}>
                                                                        <ReactSlider
                                                                            className="horizontal-slider"
                                                                            max={8}
                                                                            min={0}
                                                        ...
                                                        <div className="col-lg-12 container-slide">
                                                            <p className="subtitle">PRECIO:
                                                                <b className="rest-font value-filter">HASTA ${this.claculaSms()}</b>
                                                            </p>
                                                            <div className="row">
                                                                <div className="col-lg-12">
                                                                    <div className="whith-silider" ref={this.smsRef}>
