        ...
        return (
            <div className="row">
                        ...
                        <div className="col-lg-7 mt-2 pl-0">
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div class="btn-group">
                                        <button
                                            class="btn btn-sm dropdown-toggle prepagoDrop"
                                            type="button"
                                            ...
                                            <span className="positionDrop">
                                                <strong>
                                                    <i class="fa fa-info-circle"></i>Prepago</strong>
                                ...
                                <div className="col-lg-12 ">
                                    <p className="mb-0 p-font">
                                        <strong>
                                            <i class="fa fa-signal mr-2"></i>Red: AT&T</strong>
                                    </p>
                                    <p className="mb-0 p-font">
                                    ...
                                    <p className="mb-0 p-font">
                                        <i class="fa fa-check mr-2"></i>SMS<span>00</span>
                                    </p>
                                    <p className="mb-0 p-font">
                                        <i class="fa fa-check mr-2"></i>Datos Ilimitados<span>00</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-lg-2">
                    ...
                    <p className="mb-0"><small>Vigencia 1 día</small></p>
