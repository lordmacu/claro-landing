                                                    ...
                                                    <div className="col-lg-3 donut-right">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12 sutitles-donut">
                                                                ...
                                                                <p className="font-weight mb-0"> + </p> 
                                            ...
                                            <div className="col-lg-3">
                                                <div className="row pl-1">
                                                    <div className="col-lg-12 text-center">
                                                        ...
                                                        <p className="font-size-price-main "><span className="font-simbol">$</span><span>0</span><span className="month-font">/mes</span></p>
                                                        <p className="after">antes<span>$ 350</span></p>
                                                    </div>
                                                    <div className="col-lg-12 ml-3">
                                                        <div className="border-main border-bottom">
                                                            <Link to='/list'>
                                                                <button type="submit" href="/list" className="btn btn-danger mb-2 btns-maind">Buscar</button>
                                                            </Link>
                                                            <button type="submit" href="/list" className="btn btn-primary btns-maind">Buscar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
