            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="row">
                            <div className="col-lg-4 col-sm-12  display-on-in-desktop">
                                <img className="img-list" src="./imagen/elige.png"/>
                                <p className="font-img-list">ELEGÍ TU MEJOR PLAN!</p>
                            </div>
                            <div className="col-lg-4 col-sm-12  display-on-in-mobile">
                            ...
                            <div className="col-lg-8 col-sm-12">
                                        ...
                                        <div className="col-lg-5 col-sm-12">
                                            <form className="filter-list" onSubmit={this.filterPhone}>
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-12">
                                                        <p className="subtitle">Precio:
                                                            <b className="rest-font">HASTA ${this.claculaSms()}</b>
                                                        </p>
                                                        <div className="row">
                                                            <div className="col-lg-12">
                                                                <div className="" ref={this.smsRef}>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12  pr-0">
                                                    ...
                                                    <div class="dropdown">
                                                        <a
                                                            ref={this.estadoRef}
                                                            class="btn inputColor  dropdown-toggle btn-arrow2"
                                                            href="#"
                                                            role="button"
                                                            id="dropdownMenuLink"
                                                            data-toggle="dropdown"
                                                ...
                                                <div className="col-lg-12  pr-0">
                                                    ...
                                                    <div class="dropdown">
                                                        <a
                                                            ...
                                                            class="btn inputColor  dropdown-toggle btn-arrow3"
                                                            href="#"
                                                            role="button"
                                                            id="dropdownMenuLink"
                                                            data-toggle="dropdown"
                                ...
                                <div className="col-12 display-on-in-desktop">
