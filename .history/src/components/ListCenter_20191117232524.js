                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="row">
                                                            <div className="col-lg-12 position-title-list">
                                                                <div className="row">
                                                                    <div className="col-lg-2 pt-2 pb-2 mr-3 font-GothamLight">
                                                                        <p>RESULTADO:</p>
                                                                    </div>
                                                                    <div className="col-lg-5 pl-0">
                                                                        <div class="btn-group">
                                                                            <button type="button" class="btn font-GothamLight">CON CONTRATO</button>
                                                                            <button
                                                                                type="button"
                                                                                class="btn dropdown-toggle dropdown-toggle-split pt-1 pl-0"
