                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-ms-12 pl-5">
                                            ...
                                            <div className="col-lg-12  pr-0">
                                                ...
                                                <div class="dropdown">
                                                    <a ref={this.redesRef} class="btn inputColor  dropdown-toggle btn-arrow" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    COMPAÑIAS
                                                    </a>
                                                ...
                                                <div class="dropdown">
                                                    <a ref={this.estadoRef} class="btn inputColor  dropdown-toggle btn-arrow" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    COMPAÑIAS
                                                    </a>
                                                ...
                                                <div class="dropdown">
                                                    <a ref={this.compañiaRef} class="btn inputColor  dropdown-toggle btn-arrow" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    COMPAÑIAS
                                                    </a>
