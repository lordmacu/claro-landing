                  ...
                  <ul className="nav item-list">
                    ...
                    <div className="col-lg-1">
                      <ul className="item-list nav-btn-End">
                        ...
                        <button id="embed-modal-button" type="button" class="btn btn-default btn-sm btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="fa fa-share-alt"></span> <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="#" data-toggle="modal" data-target="#share-search-results" title="Embed">Widget de Resultados</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#share-popular-providers" title="Embed">Widget de Compañías más vistas</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#share-popular-plans" title="Embed">Widget de Planes más vistos</a></li>
                        </ul>
                    </div>
                        </li>
                      </ul>
