               ...
               <div className="row">
                 ...
                 <div className="col-lg-12 nav-planes-list ">
                  ...
                  <ul class="nav item-list">
                     ...
                     <button type="button" class="btn btn-list-plan-item " onClick={(e) => this.filterPlanByKey("messages",20, e)}    >
                     <div className="row" >
                          <div className="col-lg-12">
                      ...
                      <li class="nav-item">
                      <div className="section-btn-item-list">
                     <button type="button" class="btn btn-list-plan-item "  onClick={(e) => this.getAllResults("messages",10,e)}   >
                     <div className="row">
                          <div className="col-lg-12">
                          <strong>Prepago</strong>  (68)
                          </div>
                      ...
                      <li class="nav-item">
                      <div className="section-btn-item-list">
                     <button type="button" class="btn btn-list-plan-item "  onClick={(e) => this.filterPlanByKey("internet",40, e)} >
                     <div className="row">
                          <div className="col-lg-12">
                          <strong>Prepago</strong>  (68)
                          </div>
                      ...
                      <div className="section-btn-item-list">
                     <button type="button" class="btn btn-list-plan-item "  onClick={(e) => this.clearAllResults(e)}  >
                       <div className="row">
                          <div className="col-lg-12">
                          <strong>Prepago</strong>  (68)
                          </div>
