                                                            ...
                                                            <div className="col-lg-12">
                                                                ...
                                                                <div className="whith-silider">
                                                                    <ReactSlider
                                                                        ...
                                                                        max={item.filters.length}
                                                                        min={0}
                                                                        onChange={(value) => {
                                                                        //this.filterPlanByKey("internet", this.state.stepsInternetValue[value])
                                                                        item.value="ss"+item.filters[value].value; 
                                                                            console.log("ssddd,",item.filters[value].value)
                                                                       // console.log("este es el cambio ",this.state.filters[item.id].filters);
                                                                       console.log(); 
