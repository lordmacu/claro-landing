...
class SectionList extends React.Component {
    ...
    getFilters(){
        ...
        const res = fetch('http://comparador.tiendaclaro.uy/getFilters', {
            ...
            body:JSON.stringify(this.state.stepValue)
        })
            .then((response) => {
                                                            ...
                                                            <div className="col-lg-12">
                                                                ...
                                                                <div className="whith-silider">
                                                                    <ReactSlider
                                                                        ...
                                                                        var stepsValue=this.state.stepsValue;
                                                                        stepsValue[item.id]="3";
                                                                      //  this.state.stepValue[item.id]["value"]=item.filters[value].value;
