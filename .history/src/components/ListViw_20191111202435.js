...
class SectionList extends React.Component{
    ...
    filterPlanByKey(state){
    console.log("saqui ",this.state)
               ...
               <div className="row">
                 ...
                 <div className="col-lg-12 nav-planes-list ">
                  ...
                  <ul class="nav item-list">
                     ...
                     <button type="button" class="btn btn-list-plan-item " onClick={this.filterPlanByKey(this.state.results,"messages")}>
                     <div className="row" >
                          <div className="col-lg-12">
