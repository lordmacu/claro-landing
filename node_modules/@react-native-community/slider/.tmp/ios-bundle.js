...
__d(function(g,r,i,a,m,e,d){var n=r(d[0]),t=r(d[1]),o=n(r(d[2])),u=r(d[3]);t.AppRegistry.registerComponent(u.name,function(){return o.default})},0,[1,2,344,353]);
...
__d(function(g,r,i,a,m,e,d){'use strict';var t=r(d[0]),n=r(d[1]),o=r(d[2]),s=r(d[3]),l=r(d[4]),p=r(d[5]),c=r(d[6]),u=r(d[7]),h=r(d[8]),f=r(d[9]),S=r(d[10]),v=r(d[11]),I=(function(f){function I(t,c){var u;return o(this,I),(u=s(this,l(I).call(this,t,c)))._keyExtractor=function(t,n){var o=u._subExtractor(n);return o&&o.key||String(n)},u._convertViewable=function(t){v(null!=t.index,'Received a broken ViewToken');var o=u._subExtractor(t.index);if(!o)return null;var s=o.section.keyExtractor||u.props.keyExtractor;return n({},t,{index:o.index,key:s(t.item,o.index),section:o.section})},u._onViewableItemsChanged=function(t){var n=t.viewableItems,o=t.changed;u.props.onViewableItemsChanged&&u.props.onViewableItemsChanged({viewableItems:n.map(u._convertViewable,p(u)).filter(Boolean),changed:o.map(u._convertViewable,p(u)).filter(Boolean)})},u._renderItem=function(t){var n=t.item,o=t.index,s=u._subExtractor(o);if(!s)return null;var l=s.index;if(null==l){var p=s.section;if(!0===s.header){var c=u.props.renderSectionHeader;return c?c({section:p}):null}var f=u.props.renderSectionFooter;return f?f({section:p}):null}var S=s.section.renderItem||u.props.renderItem,I=u._getSeparatorComponent(o,s);return v(S,'no renderItem!'),h.createElement(_,{SeparatorComponent:I,LeadingSeparatorComponent:0===l?u.props.SectionSeparatorComponent:void 0,cellKey:s.key,index:l,item:n,leadingItem:s.leadingItem,leadingSection:s.leadingSection,onUpdateSeparator:u._onUpdateSeparator,prevCellKey:(u._subExtractor(o-1)||{}).key,ref:function(t){u._cellRefs[s.key]=t},renderItem:S,section:s.section,trailingItem:s.trailingItem,trailingSection:s.trailingSection})},u._onUpdateSeparator=function(t,n){var o=u._cellRefs[t];o&&o.updateSeparatorProps(n)},u._cellRefs={},u._captureRef=function(t){u._listRef=t},u.state=u._computeState(t),u}return u(I,f),c(I,[{key:"scrollToLocation",value:function(t){for(var o=t.itemIndex+1,s=0;s<t.sectionIndex;s++)o+=this.props.sections[s].data.length+2;var l=n({},t,{index:o});this._listRef.scrollToIndex(l)}},{key:"getListRef",value:function(){return this._listRef}}]),c(I,[{key:"UNSAFE_componentWillReceiveProps",value:function(t){this.setState(this._computeState(t))}},{key:"_computeState",value:function(t){var o=t.ListHeaderComponent?1:0,s=[],l=t.sections.reduce(function(t,n){return s.push(t+o),t+n.data.length+2},0);return{childProps:n({},t,{renderItem:this._renderItem,ItemSeparatorComponent:void 0,data:t.sections,getItemCount:function(){return l},getItem:y,keyExtractor:this._keyExtractor,onViewableItemsChanged:t.onViewableItemsChanged?this._onViewableItemsChanged:void 0,stickyHeaderIndices:t.stickySectionHeadersEnabled?s:void 0})}}},{key:"render",value:function(){return h.createElement(S,t({},this.state.childProps,{ref:this._captureRef}))}},{key:"_subExtractor",value:function(t){for(var n=t,o=this.props.keyExtractor,s=0;s<this.props.sections.length;s++){var l=this.props.sections[s],p=l.key||String(s);if((n-=1)>=l.data.length+1)n-=l.data.length+1;else return-1===n?{section:l,key:p+':header',index:null,header:!0,trailingSection:this.props.sections[s+1]}:n===l.data.length?{section:l,key:p+':footer',index:null,header:!1,trailingSection:this.props.sections[s+1]}:{section:l,key:p+':'+(l.keyExtractor||o)(l.data[n],n),index:n,leadingItem:l.data[n-1],leadingSection:this.props.sections[s-1],trailingItem:l.data[n+1],trailingSection:this.props.sections[s+1]}}}},{key:"_getSeparatorComponent",value:function(t,n){if(!(n=n||this._subExtractor(t)))return null;var o=n.section.ItemSeparatorComponent||this.props.ItemSeparatorComponent,s=this.props.SectionSeparatorComponent,l=t===this.state.childProps.getItemCount()-1,p=n.index===n.section.data.length-1;return s&&p?s:!o||p||l?null:o}}]),I})(h.PureComponent);I.defaultProps=n({},S.defaultProps,{data:[]});var _=(function(t){function p(){var t,c;o(this,p);for(var u=arguments.length,h=new Array(u),f=0;f<u;f++)h[f]=arguments[f];return(c=s(this,(t=l(p)).call.apply(t,[this].concat(h)))).state={separatorProps:{highlighted:!1,leadingItem:c.props.item,leadingSection:c.props.leadingSection,section:c.props.section,trailingItem:c.props.trailingItem,trailingSection:c.props.trailingSection},leadingSeparatorProps:{highlighted:!1,leadingItem:c.props.leadingItem,leadingSection:c.props.leadingSection,section:c.props.section,trailingItem:c.props.item,trailingSection:c.props.trailingSection}},c._separators={highlight:function(){['leading','trailing'].forEach(function(t){return c._separators.updateProps(t,{highlighted:!0})})},unhighlight:function(){['leading','trailing'].forEach(function(t){return c._separators.updateProps(t,{highlighted:!1})})},updateProps:function(t,o){var s=c.props,l=s.LeadingSeparatorComponent,p=s.cellKey,u=s.prevCellKey;'leading'===t&&null!=l?c.setState(function(t){return{leadingSeparatorProps:n({},t.leadingSeparatorProps,o)}}):c.props.onUpdateSeparator('leading'===t&&u||p,o)}},c}return u(p,t),c(p,[{key:"updateSeparatorProps",value:function(t){this.setState(function(o){return{separatorProps:n({},o.separatorProps,t)}})}},{key:"render",value:function(){var t=this.props,n=t.LeadingSeparatorComponent,o=t.SeparatorComponent,s=t.item,l=t.index,p=t.section,c=this.props.renderItem({item:s,index:l,section:p,separators:this._separators}),u=n&&h.createElement(n,this.state.leadingSeparatorProps),S=o&&h.createElement(o,this.state.separatorProps);return u||S?h.createElement(f,null,u,c,S):c}}],[{key:"getDerivedStateFromProps",value:function(t,o){return{separatorProps:n({},o.separatorProps,{leadingItem:t.item,leadingSection:t.leadingSection,section:t.section,trailingItem:t.trailingItem,trailingSection:t.trailingSection}),leadingSeparatorProps:n({},o.leadingSeparatorProps,{leadingItem:t.leadingItem,leadingSection:t.leadingSection,section:t.section,trailingItem:t.item,trailingSection:t.trailingSection})}}}]),p})(h.Component);function y(t,n){if(!t)return null;for(var o=n-1,s=0;s<t.length;s++){if(-1===o||o===t[s].data.length)return t[s];if(o<t[s].data.length)return t[s].data[o];o-=t[s].data.length+2}return null}m.exports=I},252,[8,46,19,32,35,34,20,38,49,78,226,3]);
...
__d(function(g,r,i,a,m,e,d){'use strict';var t=r(d[0]),n={open:function(n){return t.async(function(t){for(;;)switch(t.prev=t.next){case 0:return t.abrupt("return",Promise.reject({message:'DatePickerAndroid is not supported on this platform.'}));case 1:case"end":return t.stop()}})}};m.exports=n},331,[139]);
...
__d(function(g,r,i,a,m,e,d){'use strict';var t=r(d[0]),n={open:function(n){return t.async(function(t){for(;;)switch(t.prev=t.next){case 0:return t.abrupt("return",Promise.reject({message:'TimePickerAndroid is not supported on this platform.'}));case 1:case"end":return t.stop()}})}};m.exports=n},338,[139]);
...
__d(function(g,r,i,a,m,e,d){var t=r(d[0]),n=r(d[1]);Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var l=n(r(d[2])),o=n(r(d[3])),u=n(r(d[4])),c=n(r(d[5])),f=n(r(d[6])),s=t(r(d[7])),y=r(d[8]),p=r(d[9]),v=(function(t){function n(){return(0,l.default)(this,n),(0,u.default)(this,(0,c.default)(n).apply(this,arguments))}return(0,f.default)(n,t),(0,o.default)(n,[{key:"render",value:function(){return s.default.createElement(y.ScrollView,{style:x.scrollView,contentContainerStyle:x.container},s.default.createElement(y.Text,{testID:"testTextId",style:x.title},'<Slider />'),p.examples.map(function(t,n){return s.default.createElement(y.View,{key:"slider"+n},s.default.createElement(y.Text,null,t.title),t.render())}))}}]),n})(s.Component);e.default=v;var x=y.StyleSheet.create({scrollView:{backgroundColor:'#F5FCFF'},container:{justifyContent:'center',alignItems:'center',paddingVertical:20},title:{fontSize:20,textAlign:'center',width:'100%',marginVertical:20},instructions:{textAlign:'center',color:'#333333',marginBottom:5}})},344,[345,1,19,20,32,35,38,50,2,346]);
...
__d(function(g,r,i,a,m,e,d){'use strict';var t=r(d[0]),n=r(d[1]),l=r(d[2]),u=r(d[3]),o=r(d[4]),c=r(d[5]),s=r(d[6]),p=r(d[7]),f=p.Text,C=p.StyleSheet,h=p.View,v=r(d[8]),E=(function(p){function C(){var t,l;n(this,C);for(var c=arguments.length,s=new Array(c),p=0;p<c;p++)s[p]=arguments[p];return(l=u(this,(t=o(C)).call.apply(t,[this].concat(s)))).state={value:l.props.value},l}return c(C,p),l(C,[{key:"render",value:function(){var n=this;return s.createElement(h,null,s.createElement(f,{style:k.text},this.state.value&&+this.state.value.toFixed(3)),s.createElement(v,t({},this.props,{onValueChange:function(t){return n.setState({value:t})}})))}}]),C})(s.Component);E.defaultProps={value:0};var x=(function(p){function C(){var t,l;n(this,C);for(var c=arguments.length,s=new Array(c),p=0;p<c;p++)s[p]=arguments[p];return(l=u(this,(t=o(C)).call.apply(t,[this].concat(s)))).state={slideCompletionValue:0,slideCompletionCount:0},l}return c(C,p),l(C,[{key:"render",value:function(){var n=this;return s.createElement(h,null,s.createElement(E,t({},this.props,{onSlidingComplete:function(t){return n.setState({slideCompletionValue:t,slideCompletionCount:n.state.slideCompletionCount+1})}})),s.createElement(f,null,"Completions: ",this.state.slideCompletionCount," Value:",' ',this.state.slideCompletionValue))}}]),C})(s.Component),k=C.create({text:{fontSize:14,textAlign:'center',fontWeight:'500',margin:10}});e.title='<Slider>',e.displayName='SliderExample',e.description='Slider input for numeric values',e.examples=[{title:'Default settings',render:function(){return s.createElement(E,null)}},{title:'Initial value: 0.5',render:function(){return s.createElement(E,{value:.5})}},{title:'minimumValue: -1, maximumValue: 2',render:function(){return s.createElement(E,{minimumValue:-1,maximumValue:2})}},{title:'step: 0.25',render:function(){return s.createElement(E,{step:.25})}},{title:'onSlidingComplete',render:function(){return s.createElement(x,null)}},{title:'Custom min/max track tint color',render:function(){return s.createElement(E,{minimumTrackTintColor:'blue',maximumTrackTintColor:'red',value:.5})}},{title:'Custom thumb tint color',render:function(){return s.createElement(E,{thumbTintColor:'blue'})}},{title:'Custom thumb image',platform:'ios',render:function(){return s.createElement(E,{thumbImage:r(d[9])})}},{title:'Custom track image',platform:'ios',render:function(){return s.createElement(E,{trackImage:r(d[10])})}},{title:'Custom min/max track image',platform:'ios',render:function(){return s.createElement(E,{minimumTrackImage:r(d[11]),maximumTrackImage:r(d[12])})}}]},346,[8,19,20,32,35,38,50,2,347,349,350,351,352]);
__d(function(g,r,i,a,m,e,d){'use strict';var n,t=r(d[0]),l=r(d[1]),o=r(d[2]),u=r(d[3]),s=(u.Platform,u.StyleSheet),f=r(d[4]),c=o.forwardRef(function(u,c){var p=s.compose(n.slider,u.style),v=u.onValueChange,h=u.onSlidingComplete,S=l(u,["onValueChange","onSlidingComplete"]),C=v?function(n){v(n.nativeEvent.value)}:null,V=C,R=h?function(n){h(n.nativeEvent.value)}:null;return o.createElement(f,t({},S,{ref:c,style:p,onChange:V,onSlidingComplete:R,onValueChange:C,enabled:!u.disabled,onStartShouldSetResponder:function(){return!0},onResponderTerminationRequest:function(){return!1}}))});c.defaultProps={disabled:!1,value:0,minimumValue:0,maximumValue:1,step:0},n=s.create({slider:{height:40}}),m.exports=c},347,[8,6,50,2,348]);
__d(function(g,r,i,a,m,e,d){'use strict';var t=r(d[0]).requireNativeComponent;m.exports=t('RNCSlider')},348,[2]);
__d(function(g,r,i,a,m,e,d){m.exports=r(d[0]).registerAsset({__packager_asset:!0,httpServerLocation:"/assets/example",width:128,height:128,scales:[1],hash:"cf5d66fee2f7d78b134226ddec809beb",name:"uie_thumb_big",type:"png"})},349,[166]);
__d(function(g,r,i,a,m,e,d){m.exports=r(d[0]).registerAsset({__packager_asset:!0,httpServerLocation:"/assets/example",width:18,height:18,scales:[1],hash:"af6058f322806549afcd17417003f087",name:"slider",type:"png"})},350,[166]);
__d(function(g,r,i,a,m,e,d){m.exports=r(d[0]).registerAsset({__packager_asset:!0,httpServerLocation:"/assets/example",width:9,height:18,scales:[1],hash:"fc6b11afcfc88f6ff02767816e95fd9d",name:"slider-left",type:"png"})},351,[166]);
__d(function(g,r,i,a,m,e,d){m.exports=r(d[0]).registerAsset({__packager_asset:!0,httpServerLocation:"/assets/example",width:9,height:18,scales:[1],hash:"43a3bdcebd2cb00179bbdc23a04ff8e3",name:"slider-right",type:"png"})},352,[166]);
__d(function(e,a,m,p,l,n,x){l.exports={name:"example",displayName:"example"}},353,[]);
__r(83);
__r(0);